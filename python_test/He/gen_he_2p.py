...
#  Reigen = {'idiag':0, 'ipolph': 2, 'n_phy_targ':4, 'sym_blocks':[grasp.symmetry(0,1), grasp.symmetry(1,-1)]}
  mod1 = grasp.calc_setup('He-sp-basis-gen', clear = True, clear_what = ['All'])
  ...
  mod1.CSFBasis({#'InactShell':'1s2 ', 'J':1, 'CloseCore':'He'
                  'JLow':0, 'JHigh':4,  'Parity':1, # 2J even 1 odd -1
                  'config':['orbs:(ano-20s);ref:1s2;'+\
                                  'Excite:1s->2:20s(S)',
                            'orbs:(ano-20s);ref:2s2;'+\
                                  'Excite:2s->3:20s(S)',
                            'orbs:(ano-20s);ref:3s2;'+\
                                  'Excite:3s->4:20s(S)',
                            'orbs:(ano-20p);ref:2p2;'+\
                                  'Excite:2p->3:20p(S)',
                            'orbs:(ano-20p);ref:3p2;'+\
                                  'Excite:3p->4:20p(S)',
                            'orbs:(ano-20p);ref:4p2;'+\
                                  'Excite:4p->5:20p(S)']
                  #          'orbs:(n1,n2);ref:2p1',
                  #          'orbs:(n1,3s);ref:3s1'] 
                 })
