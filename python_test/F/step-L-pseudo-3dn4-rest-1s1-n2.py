...
def main() :
  ...
  L_opt_3dn4 = grasp.calc_setup('L_opt_3dn4_1s1L5')#, clear = True, clear_what = ['All'])#, **Reigen)
  ...
  L_opt_3dn4.CSFBasis({'JLow':0.5, 'JHigh':2.5,  # 2J
                  'config':[
                            'orbs:(n1,n2,n3,n4);ref:1s2_2s2_2p5; Excite:1s,n2->n2,n3,n4(S,D); restrict: n1>= 1',
                            'orbs:(n1,n2,n3,n4);ref:1s2_2s2_2p4_3s1; Excite:1s,n2,3s->n2,n3,n4(S,D); restrict: n1>= 1, n2>=5',
                            'orbs:(n1,n2,n3,n4);ref:1s2_2s2_2p4_3p1; Excite:1s,n2,3p->n2,n3,n4(S,D); restrict: n1>= 1, n2>=5'
                           ]
                 })
